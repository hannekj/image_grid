...
class EditorialTemplatePreview extends StatelessWidget {
  ...
  /// Fixed height for compact layouts (e.g. bottom sheet header).
  final double? height;
  /// Fill all space offered by the parent (for bottom sheet preview).
  final bool expand;

  @override
  Widget build(BuildContext context) {
    final canvas = _EditorialPreviewCanvas(
      overlays: overlays,
...
class _EditorialPreviewCanvas extends StatelessWidget {
  const _EditorialPreviewCanvas({
    required this.overlays,
              ...
              children: [
                ...
                if (overlays.isNotEmpty)
                  OverlayTextsLayer(
                    ...
                    onSelect: (_) {},
                    onEdit: (_) {},
                    onAlignmentChanged: (_, _) {},
                    onFontSizeChanged: (_, _) {},
                    onRotationChanged: (_, _) {},
                  ),
              ],
            ),
          ),
